...
export const ArrowRightIcon: React.FC<IconProps> = ({ className = 'w-3.5 h-3.5', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const HamburgerIcon: React.FC<IconProps> = ({ className = 'w-4 h-4', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const CloseIcon: React.FC<IconProps> = ({ className = 'w-4 h-4', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const UiDesignIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const FrontendIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const LandingPagesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const TwitterIcon: React.FC<IconProps> = ({ className = 'w-3.5 h-3.5', ...props }) => (
  <svg
    className={className}
    fill="currentColor"
    viewBox="0 0 24 24"
...
export const LightningIcon: React.FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const MapIcon: React.FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
